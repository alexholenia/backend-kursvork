    ...
    <?php
        ...
        <div class="container dashboard__container">
            ...
            <main>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $user["username"]  ?> </td>
                            <td><a href="<?= ROOT_URL ?>admin/edit-user.php?id=<?= $user['id'] ?>" class="btn sm">Змінити</a></td>
                            <td><a href="<?= ROOT_URL ?>admin/delete-users.php?id=<?= $user['id'] ?>" class="btn sm danger">Видалити</a></td>
                ...
                <?php else : ?>
                    <div class="alert__message error">Юзера не знайдено</div>
                    <?php endif?>
            </main>
        </div>
    </section>
