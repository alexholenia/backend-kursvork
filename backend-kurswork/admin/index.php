                ...
                <?php if ((mysqli_num_rows($posts)) > 0 ): ?>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="<?= ROOT_URL ?>admin/edit-post.php?id=<?= $post['id'] ?>" class="btn sm">Змінити</a></td>
                            <td><a href="<?= ROOT_URL ?>admin/delete-post.php?id=<?= $post['id'] ?>" class="btn sm danger">Видалити</a></td>
                        </tr>
                        <?php endwhile ?>
                        
                    </tbody>
                <?php else :?>
                    <div class="alert alert__message error"><?= "Пост не знайдено" ?></div>
                <?php endif?>
                </table>
            </main>
        </div>
